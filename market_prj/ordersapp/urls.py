...
urlpatterns = [
    ...
    # path('edit_night/<n>'),
    path('edit_accommodation/<vv>/<int:nights>/',ordersapp.edit_accommodation,name='edit_accommodation'),
    # path('edit_accommodation/<update>/', ordersapp.OrderItemsCreate.as_view(), name='edit_accommodation'),
]
